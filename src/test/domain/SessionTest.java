...
class SessionTest {
	...
	void createSession_EmptyOrNullTitle_ThrowsIllegalArgumentException(String title) {
		assertThrows(
				...
				() -> new Session(
						exampleHeadAdmin, title, "a test description", "Example Speaker",
	...
	void createSession_NullLocation_ThrowsIllegalArgumentException(String location) {
		assertThrows(
				IllegalArgumentException.class, () -> new Session(
						exampleHeadAdmin, "Example Event", "a test description",
	...
	void createSession_StartDateMoreThan1DayInFuture_ThrowsIllegalArgumentException() {
		...
		LocalDateTime endDateTime = startDateTime.plusHours(2);
		new Session(
				exampleHeadAdmin, "Example Event", "a test description", "Example Speaker", startDateTime, endDateTime,
				exampleLocation,
				exampleCapacity
		);
	}
	...
	void createSession_StartAndEndWithinExactly30Minutes_CreatesSession() {
		new Session(
				exampleHeadAdmin, "Example Title", "a test description", "Example Speaker", exampleStartDateTime,
