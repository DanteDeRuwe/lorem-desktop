...
public class SessionCalendarFacadeTest {
	...
	@ParameterizedTest
	@MethodSource("getAllSessionCalendarsFixture")
	public void addSessionCalendar_AddsSessionCalendarCorrectly(List<SessionCalendar> listAllSessionCalendars,
			SessionCalendar calendar) {
		Mockito.when(sessionCalendarRepoDummy.findAll()).thenReturn(listAllSessionCalendars);
	...
	private static Stream<Arguments> editSessionCalendarFixture() {
		return Stream.of(Arguments.of(new SessionCalendar(LocalDate.of(2020, 9, 21), LocalDate.of(2021, 9, 20)),
				LocalDate.of(2020, 9, 20), LocalDate.of(2021, 9, 21), new ArrayList<SessionCalendar>(
						List.of(new SessionCalendar(LocalDate.of(2020, 9, 20), LocalDate.of(2021, 9, 21))))));
	}

	@ParameterizedTest
	@MethodSource("editSessionCalendarFixture")
	public void editSessionCalendar_EditsSessionCalendarCorrectly(SessionCalendar pre, LocalDate start, LocalDate end,
			List<SessionCalendar> postList) {
	...
	private static Stream<Arguments> addSessionFixture() {
		return Stream.of(Arguments.of(new Session(), new HashSet<Session>(Arrays.asList(new Session()))));
	}
